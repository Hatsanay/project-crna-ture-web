...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 02, 2023 at 06:14 PM
...
CREATE TABLE `admin` (
  ...
  `adminprofile` varchar(50) COLLATE utf8_unicode_ci NOT NULL,
...
CREATE TABLE `garage` (
  ...
  `garageprofile` text COLLATE utf8_unicode_ci NOT NULL,
