...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 16, 2022 at 05:56 PM
...
INSERT INTO `admin` (`adminid`, `adminfname`, `adminlname`, `adminprofile`, `memid`) VALUES
(1, 'หัสนัย', 'หม้อยา', '', 1);
...
INSERT INTO `garage` (`garageid`, `garagename`, `garagetel`, `garagehousenum`, `garagegroup`, `garageroad`, `garagealley`, `garagedistrict`, `garagearea`, `garageprovince`, `garagepostcode`, `garagelattitude`, `garagelonggitude`, `garageprofile`, `garageimgid`, `garageonoff`, `ownerid`, `memid`) VALUES
(1, 'หัสนัยการช่าง', '0980300822', '113/3', '3', '-', '-', 'ปากน้ำ', 'เมืองกระบี่', 'จังหวัดกระบี่', '81000', '', '', '', '', '', 1, 2),
(2, 'หัสนัยการช่าง2', '0980300822', '113/3', '3', '-', '-', 'ปากน้ำ', 'เมืองกระบี่', 'จังหวัดกระบี่', '81000', '', '', '', '', '', 2, 3);
...
INSERT INTO `mechanic` (`mechanicid`, `mechanicfullname`, `mechanicsex`, `mechanicbirthday`, `mechanictel`, `mechanichousenum`, `mechanicgroup`, `mechanicroad`, `mechanicalley`, `mechanicdistrict`, `mechanicarea`, `mechanicprovince`, `mechanicpostcode`, `mechanicprofile`, `mechaniconoff`, `memid`) VALUES
(1, 'หัสนัยหม้อยา', '1', '0000-00-00', '0980300822', '113/3', '3', '-', '-', 'ปากน้ำ', 'เมืองกระบี่', 'จังหวัดกระบี่', '81000', '', '', 4);
...
(1, 'admin1', '1234', 'hatsanay022com@gmail.com', '5', '2022-12-16'),
(2, 'hatsanai1', '1234', 'hatsanay022com@gmail.com', '2', '2022-12-16'),
(3, 'hatsanai2', '1234', 'hatsanay022com@gmail.com', '2', '2022-12-16'),
(4, 'hatsanai3', '1234', 'hatsanay022com@gmail.com', '3', '2022-12-16');
...
INSERT INTO `owner` (`ownerid`, `ownerfname`, `ownerlname`, `ownersex`, `ownerbirthday`, `ownertel`, `owneraddress`, `ownhousenum`, `owngroup`, `ownalley`, `ownroad`, `owndistrict`, `ownarea`, `ownprovince`, `ownpostcode`) VALUES
(1, 'หัสนัย', 'หม้อยา', '1', '0000-00-00', '0980300822', '', '113/3', '3', '-', '-', 'ปากน้ำ', 'เมืองกระบี่', 'จังหวัดกระบี่', '81000'),
(2, 'หัสนัย', 'หม้อยา', '1', '0000-00-00', '0980300822', '', '113/3', '3', '-', '-', 'ปากน้ำ', 'เมืองกระบี่', 'จังหวัดกระบี่', '81000');
...
--
ALTER TABLE `garage`
  MODIFY `garageid` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT for table `mechanic`
--
ALTER TABLE `mechanic`
  MODIFY `mechanicid` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `members`
--
ALTER TABLE `members`
  MODIFY `memid` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT for table `owner`
--
ALTER TABLE `owner`
  MODIFY `ownerid` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
