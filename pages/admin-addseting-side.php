...
<?php
  ...
  if (isset($_SESSION['logged_in']) && $_SESSION['logged_in'] == true) {
    ...
    $user_memusername = $_SESSION['user_memusername'];
  } else {
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
         ...
         <li class="nav-item">
          ...
          <li class="nav-item">
            <a href="admin-addmechanic.php" class="nav-link">
              <i class="nav-icon fas fa-edit"></i>
              <p>
              เพิ่มช่าง
              </p>
          ...
          <li class="nav-item">
            <a href="admin-addmechanic-list.php" class="nav-link">
              <i class="nav-icon fas fa-users pd"></i>
              <p>
              รายชื่อช่าง
              </p>
            </a>
          ...
          <li class="nav-item">
            <a href="admin-addseting.php" class="nav-link active">
              <i class="nav-icon fas fa-cog pd2"></i>
              <p>
                ตั้งค่า
              </p>
            </a>
