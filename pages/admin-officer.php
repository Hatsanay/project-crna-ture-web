...
<div class="wrapper">
  ...
  <!-- Sidebar -->
    <?php
      include "admin-officer-side.php";
    ?>
  <!-- Sidebar -->
  ...
  <div class="content-wrapper kanban">
    <section class="content-header">
      ...
      ?> 
                  <tr>
                  <td><?php echo $requ['useid']?></td>
                    <td><?php echo $requ['usefname']?></td>
                    <td><?php echo $requ['uselname']?></td>
                    <td><?php echo $requ['username']?></td>
                    <td><?php echo $requ['password']?></td>
                    <td>
                      <?php 
                      if($requ['level']==1){
                      echo "ผู้ดูแลระบบ";
