    ...
    <section class="content-header">
      ...
      ?> 
                  <tr>
                    ...
                    <td>    
                        <a href="officer-list-detial.php?detial_id=<?php echo $requ['reqid']?>" class="btn btn-primary btn-a2"><i class="nav-icon fas fa-eye"></i></a>
                        <!-- <a href="admin-notify-status.php?update_id=<?php echo $requ['reqid']?>" class="btn btn-danger">ลบ</a> -->
                    </td>

                    <td>
                    <a href="officer-list-status.php?updatestatus_id=<?php echo $requ['reqid']?>" class="btn btn-success btn-a">เสร็จสิ้น</a>
                    </td>
