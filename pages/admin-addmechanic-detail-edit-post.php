<?php
    ...
    $mechanicidpost = $_POST['mechanicidpost'];
    ...
    // ,`memid`,`mechanicprofile`,`mechaniconoff`)
    //     VALUES ('$mecname','$sex','$memmecphone','$mechousenum','$mecgroup','$mecroad'
    //     ,'$mecalley','$district','$area','$province','$postcode','$memmecid1','$_P_img','$mechaniconoff')";
    $sql_update =
    "UPDATE mechanic SET 
    ,mechanicfullname = '$mecname'
    ,mechanicsex = '$sex'
    ,mechanictel = '$memmecphone'
    ,mechanichousenum = '$mechousenum'
    ,mechanicgroup = '$mecgroup'
    ,mechanicroad = '$mecroad'
    ,mechanicalley = '$mecalley'
    WHERE mechanicid = '$mechanicidpost'";
