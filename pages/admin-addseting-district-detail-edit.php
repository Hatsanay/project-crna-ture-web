...
<?php
    ...
    $sqltypememid = "SELECT * FROM `typemembers`";
  ...
  <div class="content-wrapper kanban">
    <section class="content-header">
      ...
      <?php
        ...
        $rs= $_GET['detial_id'];
        // echo "$rs";
        $sql="SELECT * FROM district WHERE districtid='$rs'";
      ...
      <div class="card card-warning">
              <div class="card-header">
                <h3 class="card-title">แก้ไขรายชื่อตำบล</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body-sm">
                <form action="admin-addseting-district-edit.php"  method="POST" onSubmit="JavaScript:return fncSubmit();" >
                  <div class="row pd">
                    <div class="col-sm-1">
                      <div class="form-group">
                        <label>ID</label>
                        <input type="text" class="form-control" placeholder="" value=<?=$row['districtid'];?> name="districtid" id="" disabled>
                      </div>
                    </div>
                    ...
                    <div class="col-sm-3">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" placeholder="" value=<?=$row['districtname'];?> name="districtname" id="districtname">
                      </div>
                    </div>
                    ...
                    <div class="col-sm-1">
                      <div class="form-group">
                        <!-- <label>ID</label> -->
                        <input type="hidden" class="form-control" placeholder="" value=<?=$row['districtid'];?> name="olddistrictid" id="olddistrictid">
                      </div>
                    </div>
