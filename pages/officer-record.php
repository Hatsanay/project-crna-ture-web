...
<div class="wrapper">
  ...
  <!-- Sidebar -->
    <?php
      include "officer-record-side.php";
    ?>
  <!-- Sidebar -->
    ...
    <section class="content-header">
      ...
      ?> 
                  <tr>
                    ...
                    <td>    
                        <a href="officer-record-detial.php?detial_id=<?php echo $requ['reqid']?>" class="btn btn-primary btn-a2"><i class="nav-icon fas fa-eye"></i></a>
