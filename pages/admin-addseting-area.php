    ...
    <section class="content-header">
      ...
      <div class="card card-warning">
              ...
              <div class="card-body-sm">
                <form action="admin-addseting-area-post.php"  method="POST" onSubmit="JavaScript:return fncSubmit();" >
                  <div class="row pd">
                    <!-- <div class="col-sm-1">
                    ...
                    <div class="col-sm-3">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" placeholder="" name="areaname" id="areaname">
                      </div>
                    </div>
                    ...
                    <div class="col-sm-1">
                      ...
                      <a href="admin-addseting-area-list.php" class="btn btn-success"><i class="fas fa-eye"></i></a>
