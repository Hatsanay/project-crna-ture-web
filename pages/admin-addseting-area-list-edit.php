    ...
    <section class="content-header">
      ...
      <div class="card">
              <div class="card-header">
                <h3 class="card-title">แก้ไขรายชื่ออำเภอ</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
      ...
      ?> 
                  ...
                  <td><?php echo $requ['areaid']?></td>
                    ...
                    <td align = "center">    
                    <a href="admin-addseting-area-detail-edit.php?detial_id=<?php echo $requ['areaid']?>" class="btn btn-warning"><i class="fas fa-pen"></i></a>
                    </td>
                  </tr>    
      <?php
          }
