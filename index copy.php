    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <div class="row" style="margin-top: 80px;"> 
          ...
          <!-- ./col -->
          <div class="col-lg-6 col-8 text3" align="center">
          <img class="logoimg" src="assets\logo2.png" alt="">
          <h1 >ระบบแจ้งซ่อมบำรุงหอพักนักศึกษา</h1>
          <a href="pages\usefrom.php" class="btn btn-primary btn-lg" style="margin-top: 25px;">แจ้งซ่อมบำรุงหอพัก</a>
          </div>
          <!-- ./col -->
        </div>
        <!-- /.row -->
